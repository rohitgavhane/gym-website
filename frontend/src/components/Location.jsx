            ...
            <section id="contact" className="py-32 bg-black relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div
                            ...
                            className="h-[600px] w-full group relative overflow-hidden"
                        >
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl lg:text-5xl font-black heading-font leading-tight text-white uppercase mb-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-40 relative z-10">
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.8 }}
                        className="bg-[var(--color-brand-card)] rounded-3xl p-10 md:p-16 flex flex-col items-center justify-center text-center gap-8 relative shadow-2xl overflow-hidden border border-white/10"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black heading-font text-white uppercase leading-tight mb-8">
                            ...
                            <div className="w-full max-w-md mx-auto relative group">
                                <input
                                    ...
                                    className="w-full bg-white/10 text-white placeholder-gray-400 font-semibold py-5 pl-6 pr-36 focus:outline-none rounded-full border border-white/20 focus:border-[var(--color-brand-lime)] transition-colors"
                                />
                                <button className="absolute right-2 top-2 bottom-2 bg-[var(--color-brand-lime)] rounded-full text-black font-black uppercase text-xs tracking-widest px-8 hover:shadow-[0_0_15px_rgba(214,255,0,0.5)] transition-all duration-300">
                                    Subscribe
                                </button>
                            </div>
                        </div>
